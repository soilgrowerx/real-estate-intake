...
<video controls="" src="https://publish-01.obsidian.md/access/f786db9fac45774fa4f0d8112e232d67/Attachments/video/obsidian-cli.mp4#t=0.001"></video>

Requires Obsidian 1.12 installer

Using the CLI requires the Obsidian 1.12 installer. See the [installer version update guide](https://help.obsidian.md/updates#Installer%20updates).

## Install Obsidian CLI

Upgrade to the latest [Obsidian installer version](https://help.obsidian.md/updates) (1.11.7) and the latest [early access version](https://help.obsidian.md/early-access) (1.12.x).

Enable Obsidian CLI in Obsidian:

On Windows you will also need to run the `.com` file, available to [Catalyst](https://help.obsidian.md/catalyst) members on Discord. See [Troubleshooting](https://help.obsidian.md/cli#Troubleshooting) for help.
...
Commands for [Bases](https://help.obsidian.md/bases).
...
Commands for [Bookmarks](https://help.obsidian.md/plugins/bookmarks).
...
Commands for [Daily notes](https://help.obsidian.md/plugins/daily-notes).
...
List versions from [File recovery](https://help.obsidian.md/plugins/file-recovery) only. See [sync:history](https://help.obsidian.md/cli#Sync) for the equivalent Sync command.
...
Commands for [Backlinks](https://help.obsidian.md/plugins/backlinks) and [Outgoing links](https://help.obsidian.md/plugins/outgoing-links).
...
Commands for [Outline](https://help.obsidian.md/plugins/outline).
...
Commands for [Core plugins](https://help.obsidian.md/plugins) and [Community plugins](https://help.obsidian.md/community-plugins).
...
Commands for [Obsidian Publish](https://help.obsidian.md/publish).
...
Commands for [Random note](https://help.obsidian.md/plugins/random-note).
...
Commands for [Search](https://help.obsidian.md/plugins/search).
...
Commands for [Obsidian Sync](https://help.obsidian.md/sync).
...
Commands for [Templates](https://help.obsidian.md/plugins/templates).
...
Commands for [Themes](https://help.obsidian.md/themes) and [CSS snippets](https://help.obsidian.md/snippets).
...
Commands for [Unique note creator](https://help.obsidian.md/plugins/unique-note).
...
Commands for [Web viewer](https://help.obsidian.md/plugins/web-viewer).
...
Commands for [Word count](https://help.obsidian.md/plugins/word-count).
...
Commands for [Workspace](https://help.obsidian.md/workspace) and the [Workspaces](https://help.obsidian.md/plugins/workspaces) plugin.
...
Commands to help you develop [Community plugins](https://help.obsidian.md/community-plugins) and [Themes](https://help.obsidian.md/themes). Learn more by heading to the [Obsidian Developer Documentation](https://docs.obsidian.md/).
...
Obsidian CLI on Windows requires the Obsidian 1.12.4+ installer. See [Installer version update](https://help.obsidian.md/updates).
