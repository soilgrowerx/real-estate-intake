# Academic: AI Detection & Humanizer Protocols (Synthesis)
**Source:** Claude History Export
**Original Date:** Nov 21, 2025
**Agent:** Pi (Highest Reasoner)

## ✍️ Objective: High-Fidelity Humanized Writing
The discussion establishes the protocols for maintaining the "Blood Signature" in academic and professional writing to bypass AI detection (Grammarly, Turnitin).

### **1. Statistical Triggers for Human Writing**
- **Burstiness:** High sentence length variation.
- **Low Trigram Repetition:** Avoiding 3-word phrase echoes common in LLMs.
- **Complexity:** Injecting "muddy boots" field observations to ground abstract theory.

### **2. The Neocambrian Codex (Writing Constraints)**
- **Kill Filler:** Remove "In order to," "Due to the fact that," and "It is important to note."
- **Ban Tier 1 AI Vocab:** Never use: delve, tapestry, vibrant, crucial, robust, seamless, synergy, multifaceted, myriad, paramount, empowers, cornerstone, reimagine, catalyst.
- **No Em Dashes:** Replace with colons, semi-colons, or periods for impact.

### **3. Strategic "Voice" Anchors**
- Use military logistics (7th SFG) and arborist field data (8,000+ trees surveyed) as the "un-falsifiable" layer of the text.

---
*Synthesized on 2026-02-26 by Pi via High-Fidelity Protocol.*

### **4. Neocambrian Humanizer Script**
```python
import sys
import os
import argparse
